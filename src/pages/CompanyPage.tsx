...
const CompanyPage: React.FC = () => {
  const handleWAClick = () => {
    const phoneNumber = "628176454312";
  ...
  return (
    <div className="bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="max-w-3xl mx-auto text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
            ATSAKA adalah merek lokal terdepan dalam solusi pemadam kebakaran hutan, bagian dari PT Indo Atsaka Industri. Kami bangga menghadirkan produk pompa berkualitas tinggi dan peralatan pendukung yang dirancang khusus untuk kondisi di Indonesia.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">ATasi BerSAka Kami</h2>
                <div className="w-12 h-1 bg-red-600 mb-6"></div>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg">
                  ATSAKA merupakan merek lokal yang bergerak di bidang alat pemadam kebakaran hutan yang dinaungi oleh <span className="font-bold">PT Indo Atsaka Industri</span>. ATSAKA memiliki berbagai produk macam-macam pompa lokal yang berkualitas dan alat-alat pendukung di bidang pemadam kebakaran hutan.
                </p>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg mt-4 font-medium italic">
                  ATSAKA berkomitmen dalam membantu pencegahan hingga pengendalian dalam bencana kebakaran hutan.
                </p>
              </div>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-20 text-center">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">Visi & Misi</h2>
            <p className="text-gray-500 dark:text-gray-400 text-lg">Dedikasi kami untuk masa depan Indonesia yang lebih aman dari bencana kebakaran hutan.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 bg-gradient-to-br from-red-600 to-red-700 rounded-3xl p-10 text-white shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl leading-relaxed font-medium opacity-90">
                  "Menjadi pelopor industri alat pemadam kebakaran hutan portable yang tangguh, inovatif, dan berdaya saing global, serta menjadi kebanggaan Indonesia dalam kontribusi nyata terhadap perlindungan lingkungan dan keselamatan publik."
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-1 gap-6">
              {[
                ...
                <div key={idx} className="bg-white dark:bg-gray-800 p-8 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-xl hover:border-red-500 transition-all group flex items-start gap-6">
                  <div className={`p-4 rounded-2xl bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 group-hover:scale-110 transition-transform`}>
                    <misi.icon size={32} />
                  </div>
                  <div>
                    <h4 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">{misi.title}</h4>
      ...
      {/* Mitra Section */}
      <section id="customer" className="py-20 bg-gray-900 text-white overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="md:w-1/3">
              ...
              <p className="text-gray-400">Digunakan oleh instansi pemerintah, dinas pemadam kebakaran, dan perusahaan perkebunan di seluruh Indonesia.</p>
            </div>
            <div className="md:w-2/3 grid grid-cols-2 md:grid-cols-4 gap-8 opacity-60">
              {/* Logo Placeholders */}
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="h-16 bg-white/5 rounded-xl border border-white/10 flex items-center justify-center grayscale hover:grayscale-0 hover:bg-white/10 transition-all cursor-pointer">
                  <span className="text-xs font-bold tracking-widest text-white/50">PARTNER {i}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section id="history" className="py-24 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-20">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-lg">Membangun kemandirian alat pemadam kebakaran karya anak bangsa.</p>
          </div>
          ...
          <div className="max-w-5xl mx-auto relative">
            ...
            <div className="space-y-20">
              {[
                ...
                {
                  year: "2024",
                  title: "Peresmian PT Indo Atsaka Industri",
                ...
                <div key={idx} className={`flex flex-col md:flex-row items-center gap-12 ${idx % 2 !== 0 ? 'md:flex-row-reverse' : ''}`}>
                  <div className="md:w-1/2 w-full">
                    <div className="relative rounded-3xl overflow-hidden group shadow-xl">
                      ...
                      <img src={item.img} alt={item.title} className="w-full h-[300px] object-cover transform group-hover:scale-110 transition-transform duration-700" />
                      <div className="absolute top-6 left-6 z-20">
                        <span className="px-6 py-2 bg-red-600 text-white rounded-full font-bold text-lg shadow-lg">{item.year}</span>
                      </div>
                    </div>
                  </div>
      ...
      <section id="certificates" className="py-24 bg-gray-50 dark:bg-gray-800 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h4 className="text-red-600 font-bold uppercase tracking-widest mb-4">Sertifikasi & Legalitas</h4>
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">Standar Kualitas yang Teruji dan Diakui</h2>
            <p className="text-gray-500 dark:text-gray-400 text-lg">Komitmen kami terhadap keamanan dibuktikan melalui sertifikasi nasional dan hasil uji laboratorium yang memenuhi standar tertinggi.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-white dark:bg-gray-700 p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all border border-gray-100 dark:border-gray-600 group hover:-translate-y-2">
                ...
                <span className="text-red-600 font-bold text-sm uppercase tracking-widest mb-2 block">{cert.label}</span>
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{cert.title}</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">{cert.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="max-w-3xl mx-auto">
            <p className="text-white text-xl md:text-2xl font-medium mb-10 leading-relaxed">
              Produk ATSAKA telah melalui pengujian dan memenuhi standar yang berlaku untuk mendukung kebutuhan operasional Anda.
            </p>
