      ...
      <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
        ...
        <div className="flex space-x-4">
          <a
            ...
            className="bg-gray-200 dark:bg-gray-700 hover:bg-red-500 hover:text-white dark:hover:bg-red-500 text-gray-600 dark:text-gray-300 p-2 rounded-full transition-colors"
            aria-label="Facebook"
          >
