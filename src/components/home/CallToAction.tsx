        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-red-100 mb-10 leading-relaxed max-w-3xl mx-auto">
              Konsultasikan kebutuhan spesifik instansi Anda dengan tim ahli
              ATSAKA. Kami siap membantu memperkuat sistem pertahanan karhutla
              Anda dengan teknologi teruji.
            </p>
